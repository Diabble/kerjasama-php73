              ...
              <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <!-- form start -->
                    <form action="{{url('/admin/kategori/kaberstore')}}" method="POST" enctype="multipart/form-data">
                      @csrf
                ...
                <tbody>
                  ...
                  <tr style="text-align: center;">
                    ...
                    <td class="project-actions text-center">
                      ...
                      <div class="modal fade text-left" id="ubahkaber{{ $row->id }}" tabindex="-1" aria-labelledby="ubahLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-scrollable">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <!-- form start -->
                              <form action="{{url('/admin/kategori/kaberupdate')}}/{{$row->id}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                  <label>Nama Kategori</label>
                      ...
                      <!-- Modal Ubah End -->
                      <a class="btn btn-danger btn-sm" href="{{url('/admin/kategori/kaberdelete')}}/{{ $row->id }}" onclick="return confirm('Yakin dihapus ?')">
            ...
            <div class="modal fade text-left" id="tambahkakoin" tabindex="-1" aria-labelledby="tambahLabel" aria-hidden="true">
              <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <!-- form start -->
                    <form action="{{url('/admin/kategori/kakoinstore')}}" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="form-group">
                ...
                <tbody>
                  ...
                  <tr style="text-align: center;">
                    ...
                    <td class="project-actions text-center">
                      ...
                      <div class="modal fade text-left" id="ubahkakoin{{ $row->id }}" tabindex="-1" aria-labelledby="ubahLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-scrollable">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <!-- form start -->
                              <form action="{{url('/admin/kategori/kakoinupdate')}}/{{ $row->id }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                  <label>Kategori Kode Instansi</label>
                                  <input class="form-control" name="nama_kategori" autocomplete="off" placeholder="Enter..." value="{{ $row->nama_kategori }}">
                      ...
                      <!-- Modal Ubah End -->
                      <a class="btn btn-danger btn-sm" href="{{url('/admin/kategori/kakoindelete')}}/{{ $row->id }}" onclick="return confirm('Yakin dihapus ?')">
                        <i class="fas fa-trash"></i>
                        Hapus
                      </a>
                    </td>
            ...
            <div class="modal fade text-left" id="tambahkakein" tabindex="-1" aria-labelledby="tambahLabel" aria-hidden="true">
              <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <!-- form start -->
                    <form action="{{url('/admin/kategori/kakeinstore')}}" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="form-group">
                ...
                <tbody>
                  ...
                  <tr style="text-align: center;">
                    ...
                    <td class="project-actions text-center">
                      ...
                      <div class="modal fade text-left" id="ubahkakein{{$row->id}}" tabindex="-1" aria-labelledby="ubahLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-scrollable">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <!-- form start -->
                              <form action="{{url('/admin/kategori/kakeinupdate')}}/{{$row->id}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                  <label>Kategori Keterangan Instansi</label>
                                  <input class="form-control" name="nama_kategori" autocomplete="off" placeholder="Enter..." value="{{ $row->nama_kategori }}">
                      ...
                      <!-- Modal Ubah End -->
                      <a class="btn btn-danger btn-sm" href="{{url('/admin/kategori/kakeindelete')}}/{{$row->id}}" onclick="return confirm('Yakin dihapus ?')">
                        <i class="fas fa-trash"></i>
                        Hapus
                      </a>
                    </td>
            ...
            <div class="modal fade text-left" id="tambahkajena" tabindex="-1" aria-labelledby="tambahLabel" aria-hidden="true">
              <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <!-- form start -->
                    <form action="{{url('/admin/kategori/kajenastore')}}" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="form-group">
                ...
                <tbody>
                  ...
                  <tr style="text-align: center;">
                    ...
                    <td class="project-actions text-center">
                      ...
                      <div class="modal fade text-left" id="ubahkajena{{$row->id}}" tabindex="-1" aria-labelledby="ubahLabel" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-scrollable">
                          <div class="modal-content">
                            ...
                            <div class="modal-body">
                              <!-- form start -->
                              <form action="{{url('/admin/kategori/kajenaupdate')}}/{{$row->id}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                <div class="form-group">
                                  <label>Kategori Jenis Naskah</label>
                                  <input class="form-control" name="nama_kategori" autocomplete="off" placeholder="Enter..." value="{{ $row->nama_kategori }}">
                      ...
                      <!-- Modal Ubah End -->
                      <a class="btn btn-danger btn-sm" href="{{url('/admin/kategori/kajenadelete')}}/{{$row->id}}" onclick="return confirm('Yakin dihapus ?')">
                        <i class="fas fa-trash"></i>
                        Hapus
                      </a>
                    </td>
