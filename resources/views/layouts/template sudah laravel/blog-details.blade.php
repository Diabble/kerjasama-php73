						...
						<div class="col-xl-9 col-lg-8 col-12">
							<div class="post-wrapper blog-details">
								<div class="single-blog">
									<div class="image-box">
										<img src="{{ asset('assets') }}/front/images/blog/9.jpg" alt="">
									...
									<div class="post-meta">
										...
										<div class="mark-text">
											<div class="row">
												<div class="col-md-5"><img src="{{ asset('assets') }}/front/images/blog/13.jpg" alt=""></div>
												<div class="col-md-7">
								...
								<div class="row">
									<div class="related-post-slider">
										<div class="item">
											<div class="single-blog">
												<div class="image-box">
													<img src="{{ asset('assets') }}/front/images/blog/14.jpg" alt="">
													<div class="overlay"><a href="#" class="date">Feb 06, 2018</a></div>
												</div> <!-- /.image-box -->
												<div class="post-meta">
										...
										<div class="item">
											<div class="single-blog">
												<div class="image-box">
													<img src="{{ asset('assets') }}/front/images/blog/15.jpg" alt="">
										...
										<div class="item">
											<div class="single-blog">
												<div class="image-box">
													<img src="{{ asset('assets') }}/front/images/blog/16.jpg" alt="">
