					...
					<div class="row">
						<div class="col-xl-9 col-lg-8 col-12">
							<div class="service-content">
								<img src="{{ asset('assets') }}/front/images/home/20.jpg" alt="" class="cover-img">
								...
								<div class="presentation-section">
									...
									<div class="row">
										...
										<div class="col-md-6 col-12"><img src="{{ asset('assets') }}/front/images/home/pattern3.png" alt="" class="chart"></div>
									</div>
								...
								<div class="market-growth">
									...
									<div class="wrapper">
										<div class="row">
											<div class="col-xl-6 col-md-5 col-12"><img src="{{ asset('assets') }}/front/images/home/21.jpg" alt=""></div>
