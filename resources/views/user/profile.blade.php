      ...
      <div class="container-fluid">
        <div class="card card-primary">
          ...
          <div class="card-body" style="display:grid; grid-template-columns:25% auto;">
            <table class="table table-hover">
              <tbody>
                <tr>
                  @if (Auth::user()->poto)
                    <img class="img-circle elevation-2 img-fluid" src="{{ asset('storage/' . Auth::user()->poto) }}" alt="User Avatar">
                  @else
          ...
          <div class="card-footer" style="display: block;">
            ...
            <a class="btn btn-danger btn-sm" href="{{url('/user/profile/avatar-update')}}/{{$user->id}}" onclick="return confirm('Yakin dihapus ?')">
