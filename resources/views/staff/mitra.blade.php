        ...
        <section class="content">
            <div class="container-fluid">
              ...
              Export Data
                        ...
                        <div class="modal fade text-left" id="import" tabindex="-1" aria-labelledby="importLabel"
                            aria-hidden="true">
                            <div class="modal-dialog modal-dialog-scrollable">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <!-- form start -->
                                        <form action="{{ url('/staff/mitra/import') }}" method="POST"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="file"
                                                    ...
                                                    id="inputGroupFile02" name="import">
                                                @error('import')
                        ...
                        <div class="modal fade text-left" id="tambah" tabindex="-1" aria-labelledby="tambahLabel"
                            ...
                            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <!-- form start -->
                                        <form action="{{ url('/staff/mitra/store') }}" method="POST"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <div class="form-group">
                                                <label>Kode Instansi</label>
                                                <select name="kodeinstansi" id="inputStatus"
                                                    class="form-control custom-select @error('kodeinstansi') is-invalid @enderror">
                                                    <option disabled selected>- Pilih -</option>
                                                    @foreach ($kakoin as $row)
                                                        <option value="{{ $row->id }}"
                                                            {{ old('kodeinstansi') == $row->id ? 'selected' : null }}>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="ketinstansi" id="inputStatus"
                                                    class="form-control custom-select @error('ketinstansi') is-invalid @enderror">
                                                    <option disabled selected>- Pilih -</option>
                                                    @foreach ($kakein as $row)
                                                        <option value="{{ $row->id }}"
                                                            {{ old('ketinstansi') == $row->id ? 'selected' : null }}>
                                                            {{ $row->nama_kategori }}</option>
                                                    @endforeach
                                                </select>
                                                @error('ketinstansi')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control @error('instansi') is-invalid @enderror"
                                                    name="instansi" autocomplete="off" placeholder="Enter..."
                                                    value="{{ old('instansi') }}">
                                                @error('instansi')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control @error('bidkerjasama') is-invalid @enderror" name="bidkerjasama" id="editor"
                                                    placeholder="Enter..."
                                                    value="">{{ old('bidkerjasama') }}</textarea>
                                                @error('bidkerjasama')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                                            <div class="form-group">
                                                <label>Dimulai</label>
                                                <div class="input-group date @error('mulai') is-invalid @enderror"
                                                    id="datetimepicker" data-target-input="nearest">
                                                    <input type="text" class="form-control datetimepicker-input"
                                                        data-target="#datetimepicker" name="mulai" placeholder="Enter..."
                                                        value="{{ old('mulai') }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date @error('selesai') is-invalid @enderror"
                                                    id="datetimepicker1" data-target-input="nearest">
                                                    <input type="text" class="form-control datetimepicker-input"
                                                        data-target="#datetimepicker1" name="selesai" placeholder="Enter..."
                                                        value="{{ old('selesai') }}">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="jenisnaskah" id="inputStatus"
                                                    class="form-control custom-select @error('jenisnaskah') is-invalid @enderror">
                                                    <option disabled selected>- Pilih -</option>
                                                    @foreach ($kajenas as $row)
                                                        <option value="{{ $row->id }}"
                                                            {{ old('jenisnaskah') == $row->id ? 'selected' : null }}>
                                                            {{ $row->nama_kategori }}</option>
                                                    @endforeach
                                                </select>
                                                @error('jenisnaskah')
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input class="form-control @error('ketunit') is-invalid @enderror"
                                                    name="ketunit" autocomplete="off" placeholder="Enter..."
                                                    value="{{ old('ketunit') }}">
                                                @error('ketunit')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            ...
                                            <div class="form-group">
                                                <label>Berkas Mitra</label>
                                                <input type="file"
                                                    class="form-control @error('berkasmitra') is-invalid @enderror"
                                                    id="inputGroupFile02" name="berkasmitra">
                                                @error('berkasmitra')
                                                    <div class="invalid-feedback">{{ $message }}</div>
                                                @enderror
                                            </div>
                        ...
                        <a class="btn btn-secondary btn-sm float-right" href="{{ url('/staff/mitra-print') }}"
                            target="blank">
                            <i class="fas fa-print"></i>
                            Cetak Semua
                        </a>
                        ...
                        <!-- Modal Ubah Start -->
                        <div class="modal fade text-left" id="ubah" tabindex="-1" aria-labelledby="ubahLabel"
                            aria-hidden="true">
                            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                    ...
                                    <div class="modal-body">
                                        ...
                                        <form action="" method="POST" enctype="multipart/form-data" id="formubah">
                                            ...
                                            <div class="form-group">
                                                <label>Kode Instansi</label>
                                                <select id="kodeinstansi" class="form-control custom-select kodeinstansi"
                                                    name="kodeinstansi">
                                                    <option disabled>- Pilih -</option>
                                                    @foreach ($kakoin as $koin)
                                                        <option value="{{ $koin->id }}">{{ $koin->nama_kategori }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label>Keterangan Instansi</label>
                                                <select id="ketinstansi" class="form-control custom-select ketinstansi"
                                                    name="ketinstansi">
                                                    <option disabled>- Pilih -</option>
                                                    @foreach ($kakein as $kein)
                                                        <option value="{{ $kein->id }}">{{ $kein->nama_kategori }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label>Instansi</label>
                                                <input class="form-control instansi" name="instansi" id="instansi"
                                                    autocomplete="off" placeholder="Enter..." value="">
                                            </div>
                                            <div class="form-group">
                                                <label>Bidang Kerjasama</label>
                                                <textarea class="form-control bidkerjasama" name="bidkerjasama" id="bidkerjasama" placeholder="Enter..."
                                                    value=""></textarea>
                                            </div>
                                            <div class="form-group">
                                                <label>Dimulai</label>
                                                ...
                                                <div class="input-group date" id="datetimepicker3"
                                                    ...
                                                    <input type="text" class="form-control datetimepicker-input"
                                                        data-target="#datetimepicker3" name="mulai" id="mulai"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="input-group date" id="datetimepicker4"
                                                    data-target-input="nearest">
                                                    <input type="text" class="form-control datetimepicker-input"
                                                        data-target="#datetimepicker4" name="selesai" id="selesai"
                                                        placeholder="Enter..." value="">
                                            ...
                                            <div class="form-group">
                                                <label>Jenis Naskah</label>
                                                <select id="jenisnaskah" class="form-control custom-select jenisnaskah"
                                                    name="jenisnaskah">
                                                    <option disabled>- Pilih -</option>
                                                    @foreach ($kajenas as $jenas)
                                                        <option value="{{ $jenas->id }}">{{ $jenas->nama_kategori }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="form-group">
                                                <label>Keterangan/Unit</label>
                                                <input class="form-control ketunit" name="ketunit" id="ketunit"
                                                    autocomplete="off" placeholder="Enter..." value="">
                                            </div>
                                            <div class="form-group">
                                                <label>File</label>
                      ...
                      {{$row->berkasmitra}}
                                            ...
                                            <td class="project-actions text-center" style="padding: 10px 10px 10px 10px;">
                                                ...
                                                <button type="button" class="btn btn-success btn-sm" data-toggle="modal"
                                                    data-target="#lihat{{ $row->id }}">
                                                    <i class="fas fa-eye"></i>
                                                    Lihat
                                                </button>
                                                <!-- Modal Lihat Start -->
                                                <div class="modal fade text-left" id="lihat{{ $row->id }}"
                                                    tabindex="-1" aria-labelledby="lihatLabel" aria-hidden="true">
                                                    <div class="modal-dialog modal-dialog-scrollable modal-lg">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                ...
                                                <button type="button" class="btn btn-warning btn-sm" data-toggle="modal"
                                                    data-target="#ubah" onclick="update({
                            id: {{ $row->id }},
                            ...
                            ketunit: '{{ $row->ketunit }}',
                                                ...
                                                <a class="btn btn-danger btn-sm"
                                                    href="{{ url('/staff/mitra/delete') }}/{{ $row->id }}"
                                                    onclick="return confirm('Yakin dihapus ?')">
                                                    <i class="fas fa-trash"></i>
                                                    Hapus
                                                </a>
                                                <a class="btn btn-secondary btn-sm"
                                                    href="{{ asset('storage/' . $row->berkasmitra) }}">
