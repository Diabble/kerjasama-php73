        ...
        <ul class="dropdown-menu" style="border-radius: .25rem; top:45px;">
          <div class="card card-widget widget-user shadow" style="margin-bottom: 0px">
            ...
            <div class="widget-user-header bg-primary">
              <p class="widget-user-username" style="font-size: 20px; font-weight: 600;">{{ Auth::user()->name }}</p>
              {{-- < class="widget-user-desc">Member Since {{ Carbon\Carbon::parse(Auth::user()->created_at)->translatedFormat('l, d F Y') }}</> --}}
            </div>
