      ...
      <div class="container-fluid">
        <div class="card card-primary">
          ...
          <div class="card-footer" style="display: block;">
            ...
            <a class="btn btn-danger btn-sm" href="{{url('/staff/profile/avatar-update')}}/{{$user->id}}" onclick="return confirm('Yakin dihapus ?')">
                ...
                <div class="modal-dialog modal-dialog-scrollable">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">
                      <!-- form start -->
                      <form action="{{url('/staff/profile/update')}}/{{$user->id}}')}}" method="POST" enctype="multipart/form-data">
                        @csrf
