      ...
      <div class="container-fluid">
        <div class="card card-primary">
          ...
          <div class="card-body" style="background-color: #ffffff; padding: 10px 40px 10px 40px;">
            {{-- <a class="btn btn-success btn-sm" href="/pegawai/mitra/export" target="blank">
              ...
              <div class="modal-dialog modal-dialog-scrollable">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <!-- form start -->
                    <form action="{{url('/pegawai/mitra/import')}}" method="POST" enctype="multipart/form-data">
                      @csrf
            ...
            <div class="modal fade text-left" id="tambah" tabindex="-1" aria-labelledby="tambahLabel" aria-hidden="true">
              <div class="modal-dialog modal-dialog-scrollable modal-lg">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <!-- form start -->
                    <form action="{{url('/pegawai/mitra/store')}}" method="POST" enctype="multipart/form-data">
                      @csrf
                      <div class="form-group">
            ...
            <a class="btn btn-secondary btn-sm float-right" href="{{ url('/pegawai/mitra-print') }}" target="blank">
              <i class="fas fa-print"></i>
              Cetak Semua
            </a>
                ...
                <tbody>
                  ...
                  <tr style="text-align: justify;">
                    ...
                    <td class="project-actions text-center" style="padding: 10px 10px 10px 10px;">
                      ...
                      <a class="btn btn-danger btn-sm" href="{{url('/pegawai/mitra/delete')}}/{{ $row->id }}" onclick="return confirm('Yakin dihapus ?')">
...
<script>
  ...
  function update(data){
    var url='{{ url("/pegawai/mitra/update") }}' + '/' + data.id;
