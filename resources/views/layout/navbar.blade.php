            ...
            <nav class="navbar navbar-expand-lg bg-dark navbar-dark">
                ...
                <div class="collapse navbar-collapse justify-content-between" id="navbarCollapse">
                    <div class="navbar-nav mr-auto">
                        <a href="/" class="nav-item nav-link active"><i class="fa fa-home" aria-hidden="true"></i> Beranda</a>
                        <div class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a href="/struktur" class="nav-link dropdown-item">Struktur</a>
                            </div>
                        </div>
                        <div class="nav-item dropdown">
                        ...
                        <div class="nav-item dropdown">
                            <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown"><i class="fa fa-phone" aria-hidden="true"></i> Layanan</a>
                            <div class="dropdown-menu">
